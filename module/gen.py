...
class GenModule(ModuleObject):
    ...
    def __init__(self, ui):
        ...
        self.ui = ui
        self.vars = {}
        self.vars["shellcode"] = ["", "see on shellcodes/msfshellcode.txt and see the READMEBEFOREUSINGSHELLCODE.txt"]
        self.vars["source"] = ["sample/haha.bmp", "Image source file path"]
        ...
        self.module_name = "root@dkmcpro:~/gen#"
        self.image = {}
    ...
    def help_me(self):
       ...
       print "[---] 1. set shellcode <yourshellcode>              [---]"
       print "[---] 2. set source <your.bmpimagepath>             [---]"
       print "[---] 3. set output <youroutputpath>[THISISOPTIONAL][---]"
       print "[---] 4. exploit                                    [---]"
       print "[-------------------------------------------------------]"
